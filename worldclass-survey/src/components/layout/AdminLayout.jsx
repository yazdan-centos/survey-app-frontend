...
export default function AdminLayout() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-73px)] flex-col lg:flex-row">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-64 transform border-r border-slate-200 bg-white transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}
        style={{ top: '73px' }}
      >
        {/* Mobile close button */}
        <button
      ...
      <div className="flex-1">
        {/* Mobile menu button */}
        <div className="sticky top-0 z-20 border-b border-slate-200 bg-white px-4 py-3 lg:hidden">
          <button
